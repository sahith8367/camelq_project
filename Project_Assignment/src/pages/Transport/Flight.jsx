...
const Flight = () => {
  return (
    <div>
        <div className={Styles.flight1}><h1>Book Your Ticket  ᯓ  ✈︎ </h1></div>
        <div>
            <form action="" className={Styles.form1}>
                <h1>ENTER DETAILS</h1>
                <div className={Styles.fromto}> <input type="text" placeholder='From'/><p>✈︎</p><input type="text" placeholder='To' /></div>
